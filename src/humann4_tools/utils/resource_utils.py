# humann4_tools/utils/resource_utils.py
...
def estimate_memory_requirements(num_samples, tool="humann4"):
    """
    Estimate memory requirements for a tool based on the number of samples.
    
    Args:
        num_samples: Number of samples to process.
        tool: Tool name ("kneaddata" or "humann4").
